"""
Django settings for gymconnect project.
...
SECRET_KEY = 'django-insecure-np1lilf(3gnxs-9qgc)ep1aj&rk+mh0xx9$d8)9x#jqf2&-_n('
...
AUTH_USER_MODEL = 'mainapp.Administrador'
